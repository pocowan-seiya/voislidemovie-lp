...
const plans: Plan[] = [
    {
        ...
        features: [
            {
                text: '月1回 AI実践セミナー（90分、録画あり）',
                detail: '最新AIツールの実演、江藤の実践デモ',
            },
            {
                text: '週1回 AI実践共有動画配信（月4本）',
                detail: '最新AI実践、システム開発の進捗共有',
            },
            {
                text: '月2回 手放しのワークセッション（各90分、録画あり）',
                detail: '制限を手放し、無限の叡智を復活させる',
            },
            { text: '会員限定コラム配信（月2本）', detail: '実践記録、意識のシフトの記録' },
            { text: '会員専用Discord参加', detail: '会員同士の交流、実践事例の共有' },
        ],
        bonus: '初月無料（キャンペーンコード「MUGEN2026」）',
        targetAudience: [
            'じぶんの無限の叡智を使いたい',
            '手放しのワークで、自分の重さを手放したい',
            'ほんとうの自分の意識に復活したい',
            'AIを使って、ビジョンを形にしていきたい',
        ],
        ctaText: 'アウェイクンプランで始める（初月無料）',
        accentColor: '#c9a84c',
    },
    {
        id: 'manifest',
        ...
        featured: true,
        includesFrom: 'アウェイクンプラン全内容',
        features: [
            {
                text: 'AI実践セミナー月2回に増量（各90分、録画あり）',
                detail: '質問中心の実践的セッション',
            },
            {
                text: '最新AIツールの割引提供',
            ...
            {
                text: 'マニフェストプラン会員専用Discord',
                detail: '江藤へのチャット質問が可能',
            },
        ],
        bonus: '初月無料',
        targetAudience: [
            '最新AIツールを活用してビジョンを具現化したい',
            'AI実践セミナーで質問しながらフル活用したい',
            '最新AI情報をいち早くインプットしたい',
        ],
