  ...
  return (
    <div className="w-full h-full flex flex-col bg-[#1a1a1a] font-sans">
      ...
      <div className="flex-1 overflow-y-auto p-8 md:p-12 bg-[#1a1a1a]">
        <div className="max-w-3xl mx-auto bg-white/5 rounded-xl border border-white/5 min-h-[800px] shadow-2xl relative overflow-hidden">
          {/* Paper Texture/Grid */}
              ...
              lpStructure.map((section, idx) => (
                <div
                  ...
                  className={`group relative transition-all duration-700 ${
                    section.status === "final" ? "opacity-100 translate-y-0" : "opacity-80"
                  }`}
                >
                  {/* Section Label */}
